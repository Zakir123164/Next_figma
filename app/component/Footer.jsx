    ...
    <>
       <section className="footer mt-[170px] relative">
           ...
           <div className="foterDiv w-full h-[499px bg-[#F0F0F0] pt-[140px] px-[101px]">
            ...
            <div className="emailPart relative top-[-460px] left-0 w-full h-[180px] bg-[#000000] rounded-[20px] pl-16 flex justify-between items-center ">
            ...
            <div className='flex gap-3 mt-5 mb-[93px]'>
              <img src={fimg1} alt="VISA" />
              <img src={fimg2} alt="MASTERCARD" />
              <img src={fimg3} alt="PayPal" />
              <img src={fimg4} alt="Apple Pay" />
              <img src={fimg5} alt="G-Pay" />
